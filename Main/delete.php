...
$query = 'DELETE FROM USER WHERE loginemail = ' . '"' . $user . '"'; 
		...
		<div id="daddy">
			...
			<div id="content">
				...
				<div id="cB">
					...
					<div id="cB1">
						Your account is removed from our database.<br />

						You will be redirected to <a href="index.php">home page</a> in about 10 seconds.
