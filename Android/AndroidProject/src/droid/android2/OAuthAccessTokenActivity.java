...
public class OAuthAccessTokenActivity extends Activity {
	...
	protected void onResume() {
        ...
        String authorizationUrl = new GoogleAuthorizationRequestUrl(OAuth2GoogleCredentials.CLIENT_ID, OAuth2GoogleCredentials.REDIRECT_URI, OAuth2GoogleCredentials.SCOPE).build();
        ...
        webview.setWebViewClient(new WebViewClient() {  
            ...
            public void onPageFinished(WebView view, String url)  {  
            	...
            	if (url.startsWith(OAuth2GoogleCredentials.REDIRECT_URI)) {
            		try {
            			...
            			if (url.indexOf("code=")!=-1) {
	            			...
	            			String code = extractCodeFromUrl(url);
				  		      ...
				  		      AccessTokenResponse accessTokenResponse = new GoogleAuthorizationCodeGrant(new NetHttpTransport(),
										      ...
										      code,
										      OAuth2GoogleCredentials.REDIRECT_URI).execute();
			...
			private String extractCodeFromUrl(String url) {
				return url.substring(OAuth2GoogleCredentials.REDIRECT_URI.length()+7,url.length());
			}  
        });  
