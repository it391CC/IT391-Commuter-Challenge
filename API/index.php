...
xmlns:fb="http://www.facebook.com/2008/fbml">
    <head>
<title>Google/Facebook Login API Test</title>
...
?>
        ...
        <title>Google/Facebook API Testing</title>
...
<script>
 ...
 FB.init({appId: '110603805686133', status: true, cookie: true, xfbml: true });
 
     /* All the events registered */
     FB.Event.subscribe('auth.login', function(response) {
	window.location.reload(); //Code to allow the page to refresh after login.
     });
     FB.Event.subscribe('auth.logout', function(response) {
	window.location.reload(); //Code to allow the page to refresh after logout.
     });
...
<body>
	...
	<br/><h4>
	<?php if (!$fbme){ ?>		
		You are currently not logged into Facebook<br/><br/>
	<?php } ?>	

<!-- Rendered if user is logged into Facebook -->
		 <?php if ($fbme){ ?> 
<!-- Welcome message -->		
		You are currently logged into Facebook
		<!-- Display user name-->		
		<?php
		...
		<br/></h4>	
		<a href='#' id='logout' class='customLoginLink'><img src=facebook.png /><a>
<script type='text/javascript'>
 ...
 <!-- Facebook Status Update-->
      <div class="box">
        <form name="" action="<?=$config['baseurl']?>" method="post">   
            <br />
            <textarea  rows="5" cols="25" id="status" name="status"> </textarea><br />
...
<a href='#' id='login' class='customLoginLink'><img src=facebook.png /><a>
<script type='text/javascript'>
	...
	<?php } ?>	
		...
		<br/><br/>
		   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		   <iframe src="http://www.facebook.com/plugins/like.php?href=http://limbotestserver.com"
        scrolling="no" frameborder="0"
        style="border:none; width:450px; height:50px"></iframe><br>
        <hr/><br/>
 <!-- Google Login -->		
</a>
 <h4><?php if(@$_REQUEST['openid_mode'] === 'id_res'): ?>
   ...
   <img src=google.png /></a>
	...
	<?php else: ?>
	You are currently not logged into Google
	</br><br/>
	<a href="<?php echo $_SERVER['PHP_SELF'] . '?openid_mode=checkid_setup&openid_identifier=google.com/accounts/o8/id' ?>" id="LoginWithGoogleLink"><span class="google"><img src=google.png /></a>
	<?php endif; ?>
	</h4></br>
...
<div class="g-plusone" data-href="http://limbotestserver.com"></div>
...
<hr/>
<br/>
<h4> Recent mentions on Twitter using
<a href=http://phpfashion.com/twitter-for-php> http://phpfashion.com/twitter-for-php</a></h4>
<h5>
...
<a href="https://twitter.com/share" data-text="I'm going green with the Commuter Challenge!! " class="twitter-share-button">Tweet</a>
<br/>
<br/>
	</div>
