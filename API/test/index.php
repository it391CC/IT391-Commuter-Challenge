...
require_once 'apiPlusService.php';
session_start();
...
// client id, client secret, and to register your redirect uri.
 $client->setClientId('915640140580.apps.googleusercontent.com');
 $client->setClientSecret('pD-V5wBXngyuaaG7gaIZ19JY');
 $client->setRedirectUri('https://www.limbotestserver.com/test/oauth2callback');
